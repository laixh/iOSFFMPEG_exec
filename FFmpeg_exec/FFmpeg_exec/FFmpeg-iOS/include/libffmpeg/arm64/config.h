...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-libx264 --enable-encoder=libx264 --enable-decoder=hevc --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --enable-encoders --enable-encoder=png --enable-encoder=apng --enable-encoder=aac --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=png --enable-decoder=apng --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=apng --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=apng --enable-demuxer=image2 --enable-demuxer=webm_dash_manifest --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-parser=ac3 --enable-parser=apng --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-bsf=eac3_core --enable-protocols --enable-protocol=async --disable-protocol=bluray --enable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --enable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/ffmpeg-arm64/output --enable-libx264 --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/x264-arm64/output/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/x264-arm64/output/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/x264-arm64/output/include -L/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/x264-arm64/output/lib -lx264'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/laixh/GitHubCode/gitlab-ijk-lib/iOS-IJKPlayer-FFmpeg40/ios/build/ffmpeg-arm64/output/share/ffmpeg"
